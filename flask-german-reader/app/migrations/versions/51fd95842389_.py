...
Revision ID: 51fd95842389
Revises: 5a8e634d023e
Create Date: 2024-04-29 01:20:35.677916
...
revision = '51fd95842389'
down_revision = '5a8e634d023e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['word_id'], ['dictionary_entry.id'], ),
    sa.PrimaryKeyConstraint('id'),
